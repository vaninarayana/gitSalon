            ...
            */
            if ( $params['show_more_button'] === 'true' ) {
                $buttons = '<p class="wp-posts-carousel-buttons">';
                    $buttons.= '<a href="' . $post_url . '" class="wp-posts-carousel-more-button button more-link" title="' . __('Read more', 'wp-posts-carousel') . ' ' . $post->post_title . '">' . __('Read More', 'wp-posts-carousel') . '</a>';
                $buttons.= '<p>';
            }
